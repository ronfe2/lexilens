...
<!-- chat-id: 7b68baf5-2c77-44c4-b8ed-6533f5b3a87d -->
...
Rebase the task branch onto the latest `main`, resolve any conflicts, and ensure the image fullscreen preview fix is preserved alongside newer side panel behaviors (e.g., the floating "LexiLens This" button).
